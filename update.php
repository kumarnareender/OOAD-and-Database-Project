...
<table>
          ...
          while($result = mysqli_fetch_assoc($data))
          {
              ...
              <th><div class="input-group"><a type="submit" class="btn" href="updateitem.php?carno= <?php echo $result['carno'] ?>">Change price or Change quantity</a></div></th>
              </tr>
